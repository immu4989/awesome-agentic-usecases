"""Generate and evaluate Unemployment Claim Navigator scenarios."""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="unemployment-claim-navigator")
    ...
    generate.add_argument("--seed", type=int, default=149)
