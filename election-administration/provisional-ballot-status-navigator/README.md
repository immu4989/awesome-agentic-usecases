...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Provisional Ballot Status Navigator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Provisional Ballot Status Navigator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Provisional Ballot Status Navigator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Provisional Ballot Status Navigator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Provisional Ballot Status Navigator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Provisional Ballot Status Navigator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Provisional Ballot Status Navigator failure modes">
...
Status assistance must be exact, private, official, and strictly nonpartisan.
...
## The specialty: Nonpartisan Status Ledger
...
State and local election officials own voter eligibility, ballot counting, cure rules, deadlines, and official results.

Grounding: [Synthetic benchmark inspired by EAC provisional-ballot and free-access-system guidance; it is not voting or legal advice.](https://www.eac.gov/election-officials/clearinghouse-resources-election-law-policy/overview-federal-election-laws)
...
- Five fictional evidence types: `provisional_receipt`, `official_status_record`, `jurisdiction_rule`, `cure_notice`, `delivery_receipt`.
- Four safe terminals: `status_packet_ready`, `request_ballot_record`,
  `election_official_review`, and `refer_election_office`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 11.33s | $0.0005 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 0.750 | 0.917 | 0.750 | 1.000 | 0.833 | 1.000 | 0.708 | 6.34s | $0.0003 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e election-administration/provisional-ballot-status-navigator
.venv/bin/provisional-ballot-status generate --n 32 --seed 263
.venv/bin/provisional-ballot-status eval --backend mock
```
