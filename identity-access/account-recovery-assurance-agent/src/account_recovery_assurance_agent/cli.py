"""CLI: generate scenarios, run evals.
  ...
  account-recovery-assurance-agent generate --n 32 --seed 181
  account-recovery-assurance-agent eval --backend mock
  account-recovery-assurance-agent eval --backend openrouter --repeats 3
"""
