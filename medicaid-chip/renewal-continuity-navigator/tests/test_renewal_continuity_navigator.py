...
from renewal_continuity_navigator.agent import MockBackend
from renewal_continuity_navigator.evaluate import evaluate, score_run
from renewal_continuity_navigator.tools import TOOL_SCHEMAS, ToolSession
from renewal_continuity_navigator.world import generate_scenarios


def test_scenarios_are_balanced_and_reproducible():
    first = generate_scenarios(n=32, seed=431)
    second = generate_scenarios(n=32, seed=431)
...
def test_authority_trap_forbids_protected_decision():
    ...
    assert scenario.contract().expected_terminal == 'eligibility_worker_review'
