"""Public-value plus exact jurisdiction-rule provenance scoring."""
...
def score_run(scenario: Scenario, run: AgentRun, session: ToolSession) -> dict[str, float]:
    ...
    metrics["jurisdiction_rule_fidelity"] = float(
        session.declared_rule_ids == [scenario.detail["expected_rule_id"]]
    )
    ...
    metrics["public_value_exact"] *= (
        metrics["jurisdiction_rule_fidelity"]
    ...
    def run_one(scenario: Scenario, repeat: int) -> ScenarioResult:
        ...
        return ScenarioResult(
            ...
            detail={
                ...
                "expected_rule_id": scenario.detail["expected_rule_id"],
                ...
                "trace": {
                    ...
                    "declared_rule_ids": session.declared_rule_ids,
