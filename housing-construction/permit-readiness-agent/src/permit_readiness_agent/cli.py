"""Generate and evaluate Permit Readiness Agent scenarios."""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="permit-readiness-agent")
    ...
    generate.add_argument("--seed", type=int, default=163)
