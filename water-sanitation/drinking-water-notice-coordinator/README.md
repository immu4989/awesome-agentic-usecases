...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Drinking Water Notice and Service-Line Coordinator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Drinking Water Notice and Service-Line Coordinator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Drinking Water Notice and Service-Line Coordinator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Drinking Water Notice and Service-Line Coordinator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Drinking Water Notice and Service-Line Coordinator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Drinking Water Notice and Service-Line Coordinator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Drinking Water Notice and Service-Line Coordinator failure modes">
...
Unknown is an inventory state—not permission to invent a safety conclusion.
...
## The specialty: Notice-to-Action Chain
...
The water system and responsible authority own health conclusions, notices, sampling, and replacement decisions.

Grounding: [Synthetic benchmark inspired by EPA service-line inventory and public-notification workflows; it is not health guidance.](https://www.epa.gov/ground-water-and-drinking-water/planning-and-developing-service-line-inventory)
...
- Five fictional evidence types: `service_line_material`, `sample_record`, `notice_template`, `delivery_receipt`, `assistance_record`.
- Four safe terminals: `notice_packet_ready`, `request_water_record`,
  `water_authority_review`, and `refer_primacy_owner`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 0.958 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.958 | 11.67s | $0.0005 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 0.917 | 1.000 | 0.958 | 1.000 | 0.958 | 1.000 | 0.875 | 6.23s | $0.0002 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e water-sanitation/drinking-water-notice-coordinator
.venv/bin/drinking-water-notice generate --n 32 --seed 223
.venv/bin/drinking-water-notice eval --backend mock
```
