...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="IRS Notice Response Navigator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of IRS Notice Response Navigator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="IRS Notice Response Navigator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="IRS Notice Response Navigator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified IRS Notice Response Navigator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline IRS Notice Response Navigator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible IRS Notice Response Navigator failure modes">

<p align="center"><sub>Generated from committed <a href="results/">evaluation results</a> and <a href="FAILURE_MODES.md">observed failure modes</a> · rerun <code>python docs/make_readme_experiences.py</code> from the repository root</sub></p>

<!-- VISUAL-BRIEFING:END -->

# ✉️ IRS Notice Response Navigator
...
The notice number chooses the workflow; urgency does not choose the evidence.
...
## The specialty: Notice Response Map
...
The taxpayer and authorized tax professionals own tax positions; the IRS owns official determinations and account actions.

Grounding: [Synthetic benchmark inspired by IRS notice and Document Upload Tool guidance; it is not tax advice.](https://www.irs.gov/individuals/understanding-your-irs-notice-or-letter)
...
- Five fictional evidence types: `notice_copy`, `income_record`, `withholding_record`, `response_form`, `delivery_receipt`.
- Four safe terminals: `response_packet_ready`, `request_tax_record`,
  `tax_professional_review`, and `refer_notice_owner`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 11.74s | $0.0005 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 0.833 | 1.000 | 0.875 | 1.000 | 0.875 | 1.000 | 0.708 | 6.12s | $0.0002 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e federal-taxpayer-services/irs-notice-response-navigator
.venv/bin/irs-notice-response generate --n 32 --seed 227
.venv/bin/irs-notice-response eval --backend mock
```
