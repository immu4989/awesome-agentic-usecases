...
from irs_notice_response_navigator.agent import MockBackend
from irs_notice_response_navigator.evaluate import evaluate, score_run
from irs_notice_response_navigator.tools import TOOL_SCHEMAS, ToolSession
from irs_notice_response_navigator.world import generate_scenarios, gold_contract


def test_scenarios_are_balanced_and_reproducible():
    first = generate_scenarios(n=32, seed=227)
    second = generate_scenarios(n=32, seed=227)
