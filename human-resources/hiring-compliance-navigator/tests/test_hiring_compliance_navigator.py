...
from hiring_compliance_navigator.agent import MockBackend
from hiring_compliance_navigator.evaluate import evaluate, score_run
from hiring_compliance_navigator.tools import TOOL_SCHEMAS, ToolSession
from hiring_compliance_navigator.world import generate_scenarios


def test_scenarios_are_balanced_and_reproducible():
    first = generate_scenarios(n=32, seed=283)
    second = generate_scenarios(n=32, seed=283)
...
def test_authority_trap_forbids_protected_decision():
    ...
    assert scenario.contract().expected_terminal == 'hiring_compliance_review'
