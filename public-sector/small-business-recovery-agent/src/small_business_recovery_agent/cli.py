"""CLI: generate scenarios, run evals.
  ...
  small-business-recovery-agent generate --n 32 --seed 83
  small-business-recovery-agent eval --backend mock
  small-business-recovery-agent eval --backend openrouter --repeats 3
"""
