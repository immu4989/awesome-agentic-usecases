"""Generate and evaluate Household Energy Lifeline scenarios."""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="household-energy-lifeline")
    ...
    generate.add_argument("--seed", type=int, default=107)
