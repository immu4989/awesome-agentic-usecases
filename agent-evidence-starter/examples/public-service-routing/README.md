# Public Service Routing Evidence Starter
...
Help a person reach current public-service information while preserving official eligibility and record authority.

**Protected human authority:** only **Authorized program specialist** may determine eligibility, approve a request, or alter an official record.
