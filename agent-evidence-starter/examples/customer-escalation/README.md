# Customer Escalation Evidence Starter
...
Help a support team route a request using verified account and safety signals while preserving financial and account authority.

**Protected human authority:** only **Authorized support operations lead** may issue a refund, change an account, or close a safety-related case.
