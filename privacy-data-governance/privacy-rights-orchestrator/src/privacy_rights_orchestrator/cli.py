"""CLI: generate scenarios, run evals.
  ...
  privacy-rights-orchestrator generate --n 32 --seed 197
  privacy-rights-orchestrator eval --backend mock
  privacy-rights-orchestrator eval --backend openrouter --repeats 3
"""
