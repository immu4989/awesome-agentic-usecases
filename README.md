...
<picture>
  ...
  <img alt="7 industries shipping, 72 verified model-evals, 88 failure modes observed, 90 runs per model, $0 to reproduce on free tiers" src="docs/assets/stats-light.svg" width="100%">
</picture>
