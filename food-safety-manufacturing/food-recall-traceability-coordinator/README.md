...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Food Recall Traceability Coordinator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Food Recall Traceability Coordinator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Food Recall Traceability Coordinator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Food Recall Traceability Coordinator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Food Recall Traceability Coordinator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Food Recall Traceability Coordinator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Food Recall Traceability Coordinator failure modes">

<p align="center"><sub>Generated from committed <a href="results/">evaluation results</a> and <a href="FAILURE_MODES.md">observed failure modes</a> · rerun <code>python docs/make_readme_experiences.py</code> from the repository root</sub></p>

<!-- VISUAL-BRIEFING:END -->

# 🥫 Food Recall Traceability Coordinator

> **Question:** Can an agent assemble an exact lot-and-recipient trace without inventing links or deciding recall scope?

A missing lot edge can turn a fast recall into a wide, slow guess.
...
## The specialty: Trace Integrity Ledger
...
A designated recall authority owns hazard classification, recall scope, and public action.

Grounding: [Synthetic benchmark inspired by FDA Food Traceability Rule record shapes; it is not compliance advice.](https://www.fda.gov/food/food-safety-modernization-act-fsma/fsma-final-rule-requirements-additional-traceability-records-certain-foods)
...
- Five fictional evidence types: `lot_code`, `source_record`, `transformation_record`, `recipient_record`, `event_timestamp`.
- Four safe terminals: `trace_packet_ready`, `request_trace_record`,
  `recall_authority_review`, and `refer_trace_owner`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 0.958 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.958 | 11.94s | $0.0005 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 0.958 | 0.875 | 1.000 | 1.000 | 1.000 | 1.000 | 0.833 | 6.23s | $0.0002 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e food-safety-manufacturing/food-recall-traceability-coordinator
.venv/bin/food-recall-traceability generate --n 32 --seed 211
.venv/bin/food-recall-traceability eval --backend mock
```
