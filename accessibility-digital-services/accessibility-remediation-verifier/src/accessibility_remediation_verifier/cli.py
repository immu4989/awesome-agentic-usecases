"""CLI: generate scenarios, run evals.
  ...
  accessibility-remediation-verifier generate --n 32 --seed 191
  accessibility-remediation-verifier eval --backend mock
  accessibility-remediation-verifier eval --backend openrouter --repeats 3
"""
