"""Generate and evaluate Farm Disaster Deadline Agent scenarios."""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="farm-disaster-deadline")
    ...
    generate.add_argument("--seed", type=int, default=157)
