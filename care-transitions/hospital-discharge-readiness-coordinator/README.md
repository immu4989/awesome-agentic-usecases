...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Hospital Discharge Readiness Coordinator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Hospital Discharge Readiness Coordinator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Hospital Discharge Readiness Coordinator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Hospital Discharge Readiness Coordinator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Hospital Discharge Readiness Coordinator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Hospital Discharge Readiness Coordinator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Hospital Discharge Readiness Coordinator failure modes">

<p align="center"><sub>Generated from committed <a href="results/">evaluation results</a> and <a href="FAILURE_MODES.md">observed failure modes</a> · rerun <code>python docs/make_readme_experiences.py</code> from the repository root</sub></p>

<!-- VISUAL-BRIEFING:END -->

# 🏥 Hospital Discharge Readiness Coordinator
...
A printed plan is not a safe transition until every handoff is real.
...
## The specialty: Discharge Readiness Gate
...
The clinical team owns discharge, medication, treatment, and medical-necessity decisions; unresolved safety needs block automation.

Grounding: [Synthetic benchmark inspired by CMS discharge-planning requirements; it is not clinical guidance.](https://www.cms.gov/files/document/qso-25-24-hospitals.pdf)
...
- Five fictional evidence types: `medication_reconciliation`, `caregiver_confirmation`, `equipment_receipt`, `transport_plan`, `followup_receipt`.
- Four safe terminals: `transition_packet_ready`, `request_transition_record`,
  `clinical_team_review`, and `refer_receiving_provider`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 0.917 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.917 | 11.42s | $0.0006 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 6.08s | $0.0003 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e care-transitions/hospital-discharge-readiness-coordinator
.venv/bin/hospital-discharge-readiness generate --n 32 --seed 269
.venv/bin/hospital-discharge-readiness eval --backend mock
```
