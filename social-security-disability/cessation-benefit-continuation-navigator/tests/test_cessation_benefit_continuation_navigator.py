...
from cessation_benefit_continuation_navigator.agent import MockBackend
from cessation_benefit_continuation_navigator.evaluate import evaluate, score_run
from cessation_benefit_continuation_navigator.tools import TOOL_SCHEMAS, ToolSession
from cessation_benefit_continuation_navigator.world import generate_scenarios


def test_scenarios_are_balanced_and_reproducible():
    first = generate_scenarios(n=32, seed=439)
    second = generate_scenarios(n=32, seed=439)
...
def test_authority_trap_forbids_protected_decision():
    ...
    assert scenario.contract().expected_terminal == 'ssa_cessation_review'
