...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Veterans Claim Evidence Navigator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Veterans Claim Evidence Navigator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Veterans Claim Evidence Navigator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Veterans Claim Evidence Navigator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Veterans Claim Evidence Navigator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Veterans Claim Evidence Navigator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Veterans Claim Evidence Navigator failure modes">

<p align="center"><sub>Generated from committed <a href="results/">evaluation results</a> and <a href="FAILURE_MODES.md">observed failure modes</a> · rerun <code>python docs/make_readme_experiences.py</code> from the repository root</sub></p>

<!-- VISUAL-BRIEFING:END -->

# 🎖️ Veterans Claim Evidence Navigator
...
A status update helps only when it preserves the evidence and review path.
...
## The specialty: Claim Evidence Reuse Map
...
VA adjudicators own service connection and ratings; accredited representatives and the claimant own review-path choices.

Grounding: [Synthetic benchmark inspired by VA claim-status and evidence guidance; it is not benefits or legal advice.](https://www.va.gov/resources/claim-status-tool-faqs/)
...
- Five fictional evidence types: `service_record`, `medical_record`, `supporting_statement`, `requested_form`, `submission_receipt`.
- Four safe terminals: `evidence_packet_ready`, `request_claim_record`,
  `accredited_review`, and `refer_claim_channel`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 0.917 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.917 | 12.64s | $0.0006 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 0.500 | 0.708 | 0.500 | 0.875 | 0.542 | 1.000 | 0.375 | 5.89s | $0.0002 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e veterans-services/veterans-claim-evidence-navigator
.venv/bin/veterans-claim-evidence generate --n 32 --seed 229
.venv/bin/veterans-claim-evidence eval --backend mock
```
