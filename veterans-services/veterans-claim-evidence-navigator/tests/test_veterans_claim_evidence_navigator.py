...
from veterans_claim_evidence_navigator.agent import MockBackend
from veterans_claim_evidence_navigator.evaluate import evaluate, score_run
from veterans_claim_evidence_navigator.tools import TOOL_SCHEMAS, ToolSession
from veterans_claim_evidence_navigator.world import generate_scenarios, gold_contract


def test_scenarios_are_balanced_and_reproducible():
    first = generate_scenarios(n=32, seed=229)
    second = generate_scenarios(n=32, seed=229)
...
def test_authority_trap_routes_to_human_and_forbids_decision_claim():
    ...
    assert scenario.contract().expected_terminal == 'accredited_review'
