...
<p align="center">
  <img src="docs/experience.svg" width="100%" alt="Occupational License Mobility Navigator — animated case trace">
</p>
...
<img src="docs/story-v2.svg" width="100%" alt="Animated four-act story explaining the human stakes of Occupational License Mobility Navigator">

### See where the obvious answer breaks

<img src="docs/scenario-map.svg" width="100%" alt="Occupational License Mobility Navigator scenario anatomy: surface story, hidden truth, unsafe shortcut, and exact proof">

### Read the complete evidence

<img src="docs/benchmark.svg" width="100%" alt="Occupational License Mobility Navigator benchmark chart generated from committed real-model evaluations">

<img src="docs/contrast.svg" width="100%" alt="Strongest and weakest verified Occupational License Mobility Navigator result contrasted on the headline metric">

<img src="docs/result-profile.svg" width="100%" alt="Outcome, completion, latency, and cost profile for the strongest headline Occupational License Mobility Navigator result">

### Learn from the misses

<img src="docs/failure-cards.svg" width="100%" alt="Three observed and reproducible Occupational License Mobility Navigator failure modes">

<p align="center"><sub>Generated from committed <a href="results/">evaluation results</a> and <a href="FAILURE_MODES.md">observed failure modes</a> · rerun <code>python docs/make_readme_experiences.py</code> from the repository root</sub></p>

<!-- VISUAL-BRIEFING:END -->

# 🪪 Occupational License Mobility Navigator
...
A license that moves in one state may stop at the next border.
...
## The specialty: License Authority Map
...
State licensing bodies own eligibility, scope, discipline, reciprocity, compact participation, and license issuance.

Grounding: [Synthetic benchmark inspired by DOL-supported occupational-licensing mobility work; it is not licensing or legal advice.](https://www.dol.gov/sites/dolgov/files/ETA/grants/pdfs/FOA-ETA-18-06.pdf)
...
- Five fictional evidence types: `origin_license`, `occupation_code`, `destination_rule`, `compact_record`, `fee_receipt`.
- Four safe terminals: `mobility_packet_ready`, `request_license_record`,
  `licensing_board_review`, and `refer_state_authority`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [deepseek / deepseek-v4-flash](results/eval_deepseek-v4-flash.md) | 8 × 3 | 0.875 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.875 | 10.05s | $0.0004 |
| [mistral / mistral-small-latest](results/eval_mistral-small-latest.md) | 8 × 3 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 6.11s | $0.0003 |
...
```bash
python -m venv .venv
.venv/bin/pip install -e harness -e workforce-mobility/occupational-license-mobility-navigator
.venv/bin/occupational-license-mobility generate --n 32 --seed 271
.venv/bin/occupational-license-mobility eval --backend mock
```
